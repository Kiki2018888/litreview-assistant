...
- **机会 / Signals**：按项目发现局限聚类与矛盾候选，人工裁决后固化为已采纳 Signal，并导出带证据指针的 Markdown。
...
- 稀疏格 / 空白网格、NLI 矛盾引擎、写作块 feed、Zotero 同步
...
- **1.3.0** 机会 / Signals 工作台：Discover → 裁决 → 导出已采纳 Signal 的 Markdown
